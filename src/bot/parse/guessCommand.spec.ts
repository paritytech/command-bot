...
const dataProvider: DataProvider[] = [
  ...
  { suitName: "sample", command: "sample $ args", repo: "polkadot", result: "sample default --input=args" },
  {
    ...
    repo: "polkadot-sdk",
    result: "bench cumulus-assets --runtime=statemint --pallet=pallet_assets",
  },
  {
    suitName: "polkadot runtime",
    command: "bench $ pallet dev pallet_contracts",
    repo: "polkadot-sdk",
    result: "bench substrate-pallet --pallet=pallet_contracts",
  },
  {
    suitName: "substrate pallet",
    command: "bench $ runtime polkadot pallet_contracts",
    repo: "polkadot-sdk",
    result: "bench polkadot-pallet --pallet=pallet_contracts",
  },
  {
    suitName: "polkadot overhead",
    command: "bench $ overhead kusama-dev",
    repo: "polkadot-sdk",
    result: "bench polkadot-overhead",
  },
  { suitName: "polkadot all", command: "bench-all $ kusama", repo: "polkadot", result: "bench-all polkadot-all" },
  {
    suitName: "cumulus bridge-hubs",
    command: "bench $ xcm bridge-hub-kusama bridge-hubs pallet_name",
    repo: "cumulus",
    result: "bench cumulus-bridge-hubs --subcommand=xcm --runtime=bridge-hub-kusama --pallet=pallet_name",
  },
  {
